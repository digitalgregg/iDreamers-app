...
export const VideoControls = () => {
    ...
    return (
        <div className="h-[100%] w-[100%] relative rounded-[24px]">
            ...
            {!isPlay && (
                <>
                    ...
                    <div
                        onClick={handlePlay}
                        className="absolute flex flex-col gap-[10px] justify-center items-center cursor-pointer -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                    >
                        <img
