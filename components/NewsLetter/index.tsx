    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mx-auto border-[#ffffff80] mb-[50px] xs:mb-[50px] md:mb-[77px] lg:mb-[50px] 4xl:mb-[75.11px] border w-[100%] h-[58px] xs:w-[440.44px] xs:h-[58px] md:w-[637.88px] lg:w-[697px] md:h-[84px] rounded-[20px]">
          ...
          <button
            type="submit"
            className="text-[16px] w-[35%] xs:w-[144.87px] xs:text-[16px] md:w-[209.81px] md:text-[20px] lg:w-[217.65px] 4xl:w-[217.65px] 4xl:text-[20px] h-[100%] float-right rounded-[20px] bg-[#F3F1FC] text-[#31265A] font-bold cursor-pointer border border-solid border-inherit hover:bg-black hover:text-white transition ease-in-out duration-[300ms]"
          >
