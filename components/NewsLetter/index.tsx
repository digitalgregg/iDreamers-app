...
const NewsLetter = ({ status, message, onValidated }: any) => {
    ...
    return (
        <div>
            <h2 className="font-bold text-[24px] leadign-[33px]  xs:text-[24px] xs:leadign-[33px]  md:text-[36px] md:leading-[49px]  lg:text-[48px]  lg:leading-[66px] xl:text-[48px]  xl:leading-[66px] 2xl:text-[48px]  2xl:leading-[66px] 3xl:text-[48px]  3xl:leading-[66px] 4xl:text-[48px] 4xl:leading-[66px]  text-[#FFFFFF] text-center md:pb-[20px] lg:pb-[30px] 2xl:pb-[40px]">
                Subscribe to Our Newsletter
            </h2>
