    ...
    return (
        ...
        >
            <div className="2xl:w-[590px] lg:w-[497px] md:w-[270px]">
                ...
                <div className="flex 2xl:gap-[40px] md:gap-[18.64px] gap-[18.64px]">
                    <img
                        ...
                        alt=""
                        className="2xl:w-[216px] 2xl:h-[64px] md:w-[100.68px] md:h-[29.83px] w-[100.68px] h-[29.83px]"
                    />
                    <img
            ...
            <div className="2xl:w-[398.86px] lg:w-[343.31px] md:w-[324px] hidden md:block">
                <img
                    src="/img/mobileScreen.svg"
                    alt=""
                    className="w-[100%] md:h-[455.86px] lg:h-[481.99px] 2xl:h-[559.99px]"
                />
            </div>
        </div>
    );
