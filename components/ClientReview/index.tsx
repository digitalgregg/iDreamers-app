                                ...
                                >
                                    {index === sliderCount && (
                                        <div className="">
                                            ...
                                            <p className="4xl:w-[925px] lg:w-[810px] md:w-[600px] mx-auto font-medium lg:text-[20px] text-[16px] lg:leading-[32.4px] text-[#4E5256] px-2 mt-[-15px] leading-[25.92px] w-[85%]">
                                                {item.review}
                                            </p>
